    ...
    <div class="box-con tran">
        ...
        <div class="login-con f-l">
            ...
            <div class="form-group">
                ...
                <input id="username" type="text" placeholder="邮箱/手机号码"/>
            ...
            <div class="form-group">
                ...
                <button type="submit" class="tran pr">
                    ...
                    <img class="loading" src="/Public/login/images/loading.gif" style="display:block">
        ...
        <div class="signup f-l">
            ...
            <div class="signup-email">
                ...
                <div class="form-group">
                    ...
                    <span class="error-notic">密码长度不符合规范</span>
                ...
                <div class="form-group">
                    ...
                    <button type="submit" class="tran pr">
                        ...
                        <img class="loading" src="/Public/login/images/loading.gif">
        ...
        var messageVerify=function (){
            ...
            $(".get-message").on("click",function(){
                ...
                if(_handle){
                    ...
                    $(this).html('<a href="javascript:;">下一步</a><img class="loading" src="/Public/login/images/loading.gif">').addClass("move-addinf");
...
//        $(_this).focus();
    ...
    $('#login').click(function () {
        ...
        if(account.indexOf("@")!=-1){ //说明是一个邮箱
            $.ajax({
                type: "POST",
                url: "index.php?m=home&c=Log&a=checkuserbyemail",
            ...
            $.ajax({
                type: "POST",
                url: "index.php?m=home&c=Log&a=checkuserbyphone",
                data: {account:account, password:$("#password").val()},
                success: function(data){
                    if(data['status']==1){
                        setTimeout("window.location.href='index.php?m=home&c=index&a=index'",2000);
                    }
                    else {
                        alert('用户名/密码错误！');
                        return false;
